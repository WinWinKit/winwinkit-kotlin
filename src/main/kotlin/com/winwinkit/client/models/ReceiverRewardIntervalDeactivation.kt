...
data class ReceiverRewardIntervalDeactivation (

    /* The reward deactivates after a fixed interval */
    @Json(name = "variant")
    val variant: ReceiverRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReceiverRewardIntervalDeactivation.Period
