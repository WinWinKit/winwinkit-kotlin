...
data class ReferralProgramReceiverBasicRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverBasicRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverBasicRewardDeactivation.Period
