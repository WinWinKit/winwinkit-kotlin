...
data class ReferralProgramReceiverCreditRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverCreditRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverCreditRewardDeactivation.Period
