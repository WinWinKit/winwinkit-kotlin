...
data class ReferralProgramReceiverCreditRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverCreditRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverCreditRewardIntervalDeactivation.Period
