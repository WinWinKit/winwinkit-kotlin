...
data class ReferralProgramReceiverGooglePlayPromoCodeRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverGooglePlayPromoCodeRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverGooglePlayPromoCodeRewardDeactivation.Period
