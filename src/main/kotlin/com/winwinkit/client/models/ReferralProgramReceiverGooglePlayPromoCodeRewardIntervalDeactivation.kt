...
data class ReferralProgramReceiverGooglePlayPromoCodeRewardIntervalDeactivation (
    ...
    @Json(name = "variant")
    val variant: ReferralProgramReceiverGooglePlayPromoCodeRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverGooglePlayPromoCodeRewardIntervalDeactivation.Period
