...
data class ReferralProgramReceiverOfferCodeRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverOfferCodeRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverOfferCodeRewardDeactivation.Period
