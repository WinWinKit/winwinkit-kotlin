...
data class ReferralProgramReceiverOfferCodeRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverOfferCodeRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverOfferCodeRewardIntervalDeactivation.Period
