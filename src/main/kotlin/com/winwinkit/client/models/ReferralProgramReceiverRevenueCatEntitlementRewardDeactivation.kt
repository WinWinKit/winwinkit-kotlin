...
data class ReferralProgramReceiverRevenueCatEntitlementRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverRevenueCatEntitlementRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverRevenueCatEntitlementRewardDeactivation.Period
