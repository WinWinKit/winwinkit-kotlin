...
data class ReferralProgramReceiverRevenueCatEntitlementRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverRevenueCatEntitlementRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverRevenueCatEntitlementRewardIntervalDeactivation.Period
