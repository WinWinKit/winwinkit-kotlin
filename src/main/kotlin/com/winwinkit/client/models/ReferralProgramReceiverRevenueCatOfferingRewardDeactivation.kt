...
data class ReferralProgramReceiverRevenueCatOfferingRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverRevenueCatOfferingRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverRevenueCatOfferingRewardDeactivation.Period
