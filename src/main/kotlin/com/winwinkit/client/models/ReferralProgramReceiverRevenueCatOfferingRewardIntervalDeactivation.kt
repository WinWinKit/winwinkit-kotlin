...
data class ReferralProgramReceiverRevenueCatOfferingRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramReceiverRevenueCatOfferingRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramReceiverRevenueCatOfferingRewardIntervalDeactivation.Period
