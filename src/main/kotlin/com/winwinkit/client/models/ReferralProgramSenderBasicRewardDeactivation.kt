...
data class ReferralProgramSenderBasicRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderBasicRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderBasicRewardDeactivation.Period
