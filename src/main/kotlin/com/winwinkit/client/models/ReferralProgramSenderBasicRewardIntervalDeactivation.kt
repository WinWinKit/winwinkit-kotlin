...
data class ReferralProgramSenderBasicRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderBasicRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderBasicRewardIntervalDeactivation.Period
