...
data class ReferralProgramSenderCreditRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderCreditRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderCreditRewardDeactivation.Period
