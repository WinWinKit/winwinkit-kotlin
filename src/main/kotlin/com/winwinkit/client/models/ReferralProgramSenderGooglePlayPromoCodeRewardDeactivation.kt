...
data class ReferralProgramSenderGooglePlayPromoCodeRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderGooglePlayPromoCodeRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderGooglePlayPromoCodeRewardDeactivation.Period
