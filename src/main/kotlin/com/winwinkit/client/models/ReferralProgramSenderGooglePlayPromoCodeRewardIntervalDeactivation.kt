...
data class ReferralProgramSenderGooglePlayPromoCodeRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderGooglePlayPromoCodeRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderGooglePlayPromoCodeRewardIntervalDeactivation.Period
