...
data class ReferralProgramSenderOfferCodeRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderOfferCodeRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderOfferCodeRewardDeactivation.Period
