...
data class ReferralProgramSenderOfferCodeRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderOfferCodeRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderOfferCodeRewardIntervalDeactivation.Period
