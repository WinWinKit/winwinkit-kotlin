...
data class ReferralProgramSenderRevenueCatEntitlementRewardDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderRevenueCatEntitlementRewardDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderRevenueCatEntitlementRewardDeactivation.Period
