...
data class ReferralProgramSenderRevenueCatEntitlementRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderRevenueCatEntitlementRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderRevenueCatEntitlementRewardIntervalDeactivation.Period
