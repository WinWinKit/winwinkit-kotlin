...
data class ReferralProgramSenderRevenueCatOfferingRewardIntervalDeactivation (

    /* The variant of the deactivation configuration */
    @Json(name = "variant")
    val variant: ReferralProgramSenderRevenueCatOfferingRewardIntervalDeactivation.Variant,
    ...
    @Json(name = "period")
    val period: ReferralProgramSenderRevenueCatOfferingRewardIntervalDeactivation.Period
