...
class UserAffiliateApplyLinkResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UserAffiliateApplyLinkResponse
        //val modelInstance = UserAffiliateApplyLinkResponse()
